...
/-! Inlined from SigGolfCandidate.Hypertree.GroupedBalancedSignBottomSelectedLoad67; its only importer was SigGolfCandidate.Hypertree.GroupedBalancedSignBottomSelectedShift67. -/
section
namespace SigGolfCandidate.Hypertree.GroupedBalancedSignBottomSelectedLoad67
...
theorem load_steps (s : MachineState) (pc : s.pc = 0x1524) :
  ...
  have c0 : Keygen.instructionAt image 0x1524 = some (.base (.LUI .x28 0x81)) := by decide
  have c1 : Keygen.instructionAt image 0x1528 = some (.base (.ADDI .x28 .x28 0x90)) := by decide
  have c2 : Keygen.instructionAt image 0x152c = some (.base (.LD .x6 .x28 0)) := by decide
  have c3 : Keygen.instructionAt image 0x1530 = some (.base (.LUI .x28 0x81)) := by decide
  have c4 : Keygen.instructionAt image 0x1534 = some (.base (.ADDI .x28 .x28 0x98)) := by decide
  have c5 : Keygen.instructionAt image 0x1538 = some (.base (.LD .x7 .x28 0)) := by decide
  have c6 : Keygen.instructionAt image 0x153c = some (.base (.LUI .x28 0x81)) := by decide
  have c7 : Keygen.instructionAt image 0x1540 = some (.base (.ADDI .x28 .x28 0xa0)) := by decide
  have c8 : Keygen.instructionAt image 0x1544 = some (.base (.LD .x10 .x28 0)) := by decide
  apply OrdinarySteps.step s s1 _ (.base (.LUI .x28 0x81)) 8
  · simpa only [Keygen.fetch_at,pc] using c0
  · rfl
  apply OrdinarySteps.step s1 s2 _ (.base (.ADDI .x28 .x28 0x90)) 7
  · have hp : s1.pc = 0x1528 := by simp [s1,execInstrBr,pc,signExtend12,signExtend13]
    simpa only [Keygen.fetch_at,hp] using c1
  · rfl
  apply OrdinarySteps.step s2 s3 _ (.base (.LD .x6 .x28 0)) 6
  · have hp : s2.pc = 0x152c := by simp [s1,s2,execInstrBr,pc,signExtend12,signExtend13]
  ...
  · have hp : s3.pc = 0x1530 := by simp [s1,s2,s3,execInstrBr,pc,signExtend12,signExtend13]
    simpa only [Keygen.fetch_at,hp] using c3
  · rfl
  apply OrdinarySteps.step s4 s5 _ (.base (.ADDI .x28 .x28 0x98)) 4
  · have hp : s4.pc = 0x1534 := by simp [s1,s2,s3,s4,execInstrBr,pc,signExtend12,signExtend13]
    simpa only [Keygen.fetch_at,hp] using c4
  · rfl
  apply OrdinarySteps.step s5 s6 _ (.base (.LD .x7 .x28 0)) 3
  · have hp : s5.pc = 0x1538 := by simp [s1,s2,s3,s4,s5,execInstrBr,pc,signExtend12,signExtend13]
  ...
  · have hp : s6.pc = 0x153c := by simp [s1,s2,s3,s4,s5,s6,execInstrBr,pc,signExtend12,signExtend13]
    simpa only [Keygen.fetch_at,hp] using c6
  · rfl
  apply OrdinarySteps.step s7 s8 _ (.base (.ADDI .x28 .x28 0xa0)) 1
  · have hp : s7.pc = 0x1540 := by simp [s1,s2,s3,s4,s5,s6,s7,execInstrBr,pc,signExtend12,signExtend13]
    simpa only [Keygen.fetch_at,hp] using c7
  · rfl
  apply OrdinarySteps.step s8 (loadState s) _ (.base (.LD .x10 .x28 0)) 0
  · have hp : s8.pc = 0x1544 := by simp [s1,s2,s3,s4,s5,s6,s7,s8,execInstrBr,pc,signExtend12,signExtend13]
...
theorem load_pc (s : MachineState) (pc : s.pc = 0x1524) : (loadState s).pc = 0x1548 := by
  simp [loadState,execInstrBr,pc,signExtend12,signExtend13]
#print axioms load_steps
end SigGolfCandidate.Hypertree.GroupedBalancedSignBottomSelectedLoad67

end

namespace SigGolfCandidate.Hypertree.GroupedBalancedSignBottomSelectedShift67
open SigGolf SigGolf.Riscv RiscvZkvm.Rv64
open SigGolfCandidate.Hypertree
set_option maxRecDepth 8192
set_option maxHeartbeats 300000
...
theorem shift_steps (s : MachineState) (pc : s.pc = 0x1548) :
  ...
  have c0 : Keygen.instructionAt image 0x1548 = some (.base (.SLLI .x11 .x7 63)) := by decide
  have c1 : Keygen.instructionAt image 0x154c = some (.base (.SRLI .x6 .x6 1)) := by decide
  have c2 : Keygen.instructionAt image 0x1550 = some (.base (.ADD .x6 .x6 .x11)) := by decide
  have c3 : Keygen.instructionAt image 0x1554 = some (.base (.SLLI .x11 .x10 63)) := by decide
  have c4 : Keygen.instructionAt image 0x1558 = some (.base (.SRLI .x7 .x7 1)) := by decide
  have c5 : Keygen.instructionAt image 0x155c = some (.base (.ADD .x7 .x7 .x11)) := by decide
  have c6 : Keygen.instructionAt image 0x1560 = some (.base (.SRLI .x10 .x10 1)) := by decide
  have c7 : Keygen.instructionAt image 0x1564 = some (.base (.LUI .x28 0x81)) := by decide
  have c8 : Keygen.instructionAt image 0x1568 = some (.base (.ADDI .x28 .x28 0x90)) := by decide
  have c9 : Keygen.instructionAt image 0x156c = some (.base (.SD .x28 .x6 0)) := by decide
  have c10 : Keygen.instructionAt image 0x1570 = some (.base (.LUI .x28 0x81)) := by decide
  have c11 : Keygen.instructionAt image 0x1574 = some (.base (.ADDI .x28 .x28 0x98)) := by decide
  have c12 : Keygen.instructionAt image 0x1578 = some (.base (.SD .x28 .x7 0)) := by decide
  have c13 : Keygen.instructionAt image 0x157c = some (.base (.LUI .x28 0x81)) := by decide
  have c14 : Keygen.instructionAt image 0x1580 = some (.base (.ADDI .x28 .x28 0xa0)) := by decide
  have c15 : Keygen.instructionAt image 0x1584 = some (.base (.SD .x28 .x10 0)) := by decide
  apply OrdinarySteps.step s s1 _ (.base (.SLLI .x11 .x7 63)) 15
  · simpa only [Keygen.fetch_at,pc] using c0
  · rfl
  apply OrdinarySteps.step s1 s2 _ (.base (.SRLI .x6 .x6 1)) 14
  · have hp : s1.pc = 0x154c := by simp [s1,execInstrBr,pc,signExtend12,signExtend13]
    simpa only [Keygen.fetch_at,hp] using c1
  · rfl
  apply OrdinarySteps.step s2 s3 _ (.base (.ADD .x6 .x6 .x11)) 13
  · have hp : s2.pc = 0x1550 := by simp [s1,s2,execInstrBr,pc,signExtend12,signExtend13]
    simpa only [Keygen.fetch_at,hp] using c2
  · rfl
  apply OrdinarySteps.step s3 s4 _ (.base (.SLLI .x11 .x10 63)) 12
  · have hp : s3.pc = 0x1554 := by simp [s1,s2,s3,execInstrBr,pc,signExtend12,signExtend13]
    simpa only [Keygen.fetch_at,hp] using c3
  · rfl
  apply OrdinarySteps.step s4 s5 _ (.base (.SRLI .x7 .x7 1)) 11
  · have hp : s4.pc = 0x1558 := by simp [s1,s2,s3,s4,execInstrBr,pc,signExtend12,signExtend13]
    simpa only [Keygen.fetch_at,hp] using c4
  · rfl
  apply OrdinarySteps.step s5 s6 _ (.base (.ADD .x7 .x7 .x11)) 10
  · have hp : s5.pc = 0x155c := by simp [s1,s2,s3,s4,s5,execInstrBr,pc,signExtend12,signExtend13]
    simpa only [Keygen.fetch_at,hp] using c5
  · rfl
  apply OrdinarySteps.step s6 s7 _ (.base (.SRLI .x10 .x10 1)) 9
  · have hp : s6.pc = 0x1560 := by simp [s1,s2,s3,s4,s5,s6,execInstrBr,pc,signExtend12,signExtend13]
    simpa only [Keygen.fetch_at,hp] using c6
  · rfl
  apply OrdinarySteps.step s7 s8 _ (.base (.LUI .x28 0x81)) 8
  · have hp : s7.pc = 0x1564 := by simp [s1,s2,s3,s4,s5,s6,s7,execInstrBr,pc,signExtend12,signExtend13]
    simpa only [Keygen.fetch_at,hp] using c7
  · rfl
  apply OrdinarySteps.step s8 s9 _ (.base (.ADDI .x28 .x28 0x90)) 7
  · have hp : s8.pc = 0x1568 := by simp [s1,s2,s3,s4,s5,s6,s7,s8,execInstrBr,pc,signExtend12,signExtend13]
    simpa only [Keygen.fetch_at,hp] using c8
  · rfl
  apply OrdinarySteps.step s9 s10 _ (.base (.SD .x28 .x6 0)) 6
  · have hp : s9.pc = 0x156c := by simp [s1,s2,s3,s4,s5,s6,s7,s8,s9,execInstrBr,pc,signExtend12,signExtend13]
  ...
  · have hp : s10.pc = 0x1570 := by simp [s1,s2,s3,s4,s5,s6,s7,s8,s9,s10,execInstrBr,pc,signExtend12,signExtend13]
    simpa only [Keygen.fetch_at,hp] using c10
  · rfl
  apply OrdinarySteps.step s11 s12 _ (.base (.ADDI .x28 .x28 0x98)) 4
  · have hp : s11.pc = 0x1574 := by simp [s1,s2,s3,s4,s5,s6,s7,s8,s9,s10,s11,execInstrBr,pc,signExtend12,signExtend13]
    simpa only [Keygen.fetch_at,hp] using c11
  · rfl
  apply OrdinarySteps.step s12 s13 _ (.base (.SD .x28 .x7 0)) 3
  · have hp : s12.pc = 0x1578 := by simp [s1,s2,s3,s4,s5,s6,s7,s8,s9,s10,s11,s12,execInstrBr,pc,signExtend12,signExtend13]
  ...
  · have hp : s13.pc = 0x157c := by simp [s1,s2,s3,s4,s5,s6,s7,s8,s9,s10,s11,s12,s13,execInstrBr,pc,signExtend12,signExtend13]
    simpa only [Keygen.fetch_at,hp] using c13
  · rfl
  apply OrdinarySteps.step s14 s15 _ (.base (.ADDI .x28 .x28 0xa0)) 1
  · have hp : s14.pc = 0x1580 := by simp [s1,s2,s3,s4,s5,s6,s7,s8,s9,s10,s11,s12,s13,s14,execInstrBr,pc,signExtend12,signExtend13]
    simpa only [Keygen.fetch_at,hp] using c14
  · rfl
  apply OrdinarySteps.step s15 (shiftState s) _ (.base (.SD .x28 .x10 0)) 0
  · have hp : s15.pc = 0x1584 := by simp [s1,s2,s3,s4,s5,s6,s7,s8,s9,s10,s11,s12,s13,s14,s15,execInstrBr,pc,signExtend12,signExtend13]
  ...
  exact OrdinarySteps.refl _
theorem shift_pc (s : MachineState) (pc : s.pc = 0x1548) : (shiftState s).pc = 0x1588 := by
  simp [shiftState,execInstrBr,pc,signExtend12,signExtend13]
#print axioms shift_steps
end SigGolfCandidate.Hypertree.GroupedBalancedSignBottomSelectedShift67
