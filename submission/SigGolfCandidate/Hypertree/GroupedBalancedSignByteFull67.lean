...
/-! Inlined from SigGolfCandidate.Hypertree.GroupedBalancedSignByteSetup67; its only importer was SigGolfCandidate.Hypertree.GroupedBalancedSignByteFull67. -/
section
...
namespace SigGolfCandidate.Hypertree.GroupedBalancedSignByteSetup67
...
private theorem word1086 : GroupedBalancedSignImage67Byte.code[1086]? =
    some 0x00080537 := by decide
private theorem word1087 : GroupedBalancedSignImage67Byte.code[1087]? =
    some 0x50050513 := by decide
private theorem word1088 : GroupedBalancedSignImage67Byte.code[1088]? =
    some 0x000805b7 := by decide
private theorem word1089 : GroupedBalancedSignImage67Byte.code[1089]? =
    some 0x60058593 := by decide
private theorem word1090 : GroupedBalancedSignImage67Byte.code[1090]? =
    some 0x00050313 := by decide
private theorem word1091 : GroupedBalancedSignImage67Byte.code[1091]? =
    some 0x00000713 := by decide
private theorem word1092 : GroupedBalancedSignImage67Byte.code[1092]? =
    some 0x01000913 := by decide
private theorem word1093 : GroupedBalancedSignImage67Byte.code[1093]? =
    some 0x00010893 := by decide

theorem setup_steps (s : MachineState) (pc : s.pc = 0x20f8) :
    OrdinarySteps GroupedBalancedSignImage67Byte.image s 8 (setupState s) := by
  ...
  change OrdinarySteps GroupedBalancedSignImage67Byte.image s 8 s8
  apply OrdinarySteps.step s s1 _ (.base (.LUI .x10 0x80)) 7
  · simp [fetch, pc, GroupedBalancedSignImage67Byte.image, word1086]; rfl
  · rfl
  apply OrdinarySteps.step s1 s2 _ (.base (.ADDI .x10 .x10 0x500)) 6
  · have hp : s1.pc = 0x20fc := by simp [s1, execInstrBr, pc]
    simp [fetch, hp, GroupedBalancedSignImage67Byte.image, word1087]; rfl
  · rfl
  apply OrdinarySteps.step s2 s3 _ (.base (.LUI .x11 0x80)) 5
  · have hp : s2.pc = 0x2100 := by simp [s1, s2, execInstrBr, pc]
    simp [fetch, hp, GroupedBalancedSignImage67Byte.image, word1088]; rfl
  · rfl
  apply OrdinarySteps.step s3 s4 _ (.base (.ADDI .x11 .x11 0x600)) 4
  · have hp : s3.pc = 0x2104 := by simp [s1, s2, s3, execInstrBr, pc]
    simp [fetch, hp, GroupedBalancedSignImage67Byte.image, word1089]; rfl
  · rfl
  apply OrdinarySteps.step s4 s5 _ (.base (.ADDI .x6 .x10 0)) 3
  · have hp : s4.pc = 0x2108 := by simp [s1, s2, s3, s4, execInstrBr, pc]
    simp [fetch, hp, GroupedBalancedSignImage67Byte.image, word1090]; rfl
  · rfl
  apply OrdinarySteps.step s5 s6 _ (.base (.ADDI .x14 .x0 0)) 2
  · have hp : s5.pc = 0x210c := by simp [s1, s2, s3, s4, s5, execInstrBr, pc]
    simp [fetch, hp, GroupedBalancedSignImage67Byte.image, word1091]; rfl
  · rfl
  apply OrdinarySteps.step s6 s7 _ (.base (.ADDI .x18 .x0 16)) 1
  · have hp : s6.pc = 0x2110 := by simp [s1, s2, s3, s4, s5, s6, execInstrBr, pc]
    simp [fetch, hp, GroupedBalancedSignImage67Byte.image, word1092]; rfl
  · rfl
  apply OrdinarySteps.step s7 s8 _ (.base (.ADDI .x17 .x2 0)) 0
  · have hp : s7.pc = 0x2114 := by simp [s1, s2, s3, s4, s5, s6, s7, execInstrBr, pc]
    simp [fetch, hp, GroupedBalancedSignImage67Byte.image, word1093]; rfl
  · rfl
  exact OrdinarySteps.refl _

theorem setup_fields (s : MachineState) (pc : s.pc = 0x20f8)
    (stack : s.getReg .x2 = 0xfff700) :
    (setupState s).pc = 0x2118 ∧
...
end SigGolfCandidate.Hypertree.GroupedBalancedSignByteSetup67
...
namespace SigGolfCandidate.Hypertree.GroupedBalancedSignByteFull67
...
end SigGolfCandidate.Hypertree.GroupedBalancedSignByteFull67
