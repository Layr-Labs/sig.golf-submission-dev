import SigGolfCandidate.Hypertree.GroupedBalancedSignUpperTreeLowLevel67
...
/-! Inlined from SigGolfCandidate.Hypertree.GroupedBalancedSignUpperTreeParentsLow67; its only importer was SigGolfCandidate.Hypertree.GroupedBalancedSignUpperTreeCalleeLow67. -/
section
/-! Low signer memory across the complete h3/h4 parent loops. -/
namespace SigGolfCandidate.Hypertree.GroupedBalancedSignUpperTreeParentsLow67
...
theorem height3_low (hash : Hash) (s final : MachineState)
  ...
  rw [same]
  have f0 := GroupedBalancedSignUpperTreeLowLevel67.height_step_low hash
    s at1 3 treeBase witnessBase 0 4 0x83000 0x88000 ready
    (by decide) (Or.inl rfl) witnessLower witnessBound witnessAligned
    (by decide) (by decide) (Or.inl ⟨rfl,rfl⟩) t0 a low
  have f1 := GroupedBalancedSignUpperTreeLowLevel67.height_step_low hash
    at1 at2 3 treeBase witnessBase 1 2 0x88000 0x83000
    (by simpa only [show 4/2=2 by decide] using r1)
    (by decide) (Or.inl rfl) witnessLower witnessBound witnessAligned
    (by decide) (by decide) (Or.inr ⟨rfl,rfl⟩) t1 a low
  have f2 := GroupedBalancedSignUpperTreeLowLevel67.terminal_low hash
...
theorem height4_low (hash : Hash) (s final : MachineState)
    (treeBase witnessBase : Nat)
  ...
  have f0 := GroupedBalancedSignUpperTreeLowLevel67.height_step_low hash
    ...
    (by decide) (Or.inr rfl) witnessLower witnessBound witnessAligned
    (by decide) (by decide) (Or.inl ⟨rfl,rfl⟩) t0 a low
  have f1 := GroupedBalancedSignUpperTreeLowLevel67.height_step_low hash
    ...
    (by decide) (Or.inr rfl) witnessLower witnessBound witnessAligned
    (by decide) (by decide) (Or.inr ⟨rfl,rfl⟩) t1 a low
  have f2 := GroupedBalancedSignUpperTreeLowLevel67.height_step_low hash
    at2 at3 4 treeBase witnessBase 2 2 0x83000 0x88000
    (by simpa only [show 4/2=2 by decide] using r2)
    (by decide) (Or.inr rfl) witnessLower witnessBound witnessAligned
    (by decide) (by decide) (Or.inl ⟨rfl,rfl⟩) t2 a low
  have f3 := GroupedBalancedSignUpperTreeLowLevel67.terminal_low hash
...
#print axioms height3_low
#print axioms height4_low
end SigGolfCandidate.Hypertree.GroupedBalancedSignUpperTreeParentsLow67

end

/-! Final ByteSign upper Merkle callee preserves signer key and public key. -/
namespace SigGolfCandidate.Hypertree.GroupedBalancedSignUpperTreeCalleeLow67
open SigGolf SigGolf.Riscv RiscvZkvm.Rv64
open SigGolfCandidate.Hypertree
set_option maxRecDepth 8192
set_option maxHeartbeats 0
...
theorem start_low (hash : Hash) (s ready : MachineState)
    (pc : s.pc=0x1c30)
    (sp : s.getReg .x2=0xfff7e0 ∨ s.getReg .x2=0xfff700)
    (trace : Trace hash oldImage s 72 72 0 0 ready)
    (a : Word) (low : a.toNat<0x100) : ready.getMem a=s.getMem a := by
...
#print axioms start_low

theorem height3_low (hash : Hash) (s returned : MachineState)
    (treeBase witnessBase : Nat)
  ...
  exact (GroupedBalancedSignUpperTreeParentsLow67.height3_low hash ready final
    treeBase witnessBase startInv treeBound witnessLower witnessBound
    witnessAligned parentTrace a low).trans
    (start_low hash s ready pc sp startTrace a low)

theorem height4_low (hash : Hash) (s returned : MachineState)
    (treeBase witnessBase : Nat)
  ...
  have same := Trace.deterministic trace built
  rw [same,Keygen.return_mem]
  exact (GroupedBalancedSignUpperTreeParentsLow67.height4_low hash ready final
    treeBase witnessBase startInv treeBound witnessLower witnessBound
    witnessAligned parentTrace a low).trans
    (start_low hash s ready pc sp startTrace a low)
...
#print axioms height3_low
#print axioms height4_low
end SigGolfCandidate.Hypertree.GroupedBalancedSignUpperTreeCalleeLow67
