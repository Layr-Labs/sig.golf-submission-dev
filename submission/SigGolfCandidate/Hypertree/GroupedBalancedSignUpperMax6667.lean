...
namespace SigGolfCandidate.Hypertree.GroupedBalancedSignUpperMax6667
...
private theorem max_code :
    ...
    Keygen.instructionAt image 0x19ac = some (.base (.ADDI .x7 .x0 10)) ∧
...
theorem max_steps (s : MachineState) (pc : s.pc = 0x198c) (ne65 : s.getReg .x19 ≠ 65) (eq66 : s.getReg .x19 = 66) :
  ...
  have eq66bv : s.getReg .x19 = (66#64) := by simpa only [show (66 : Word) = (66#64) by decide] using eq66
  apply OrdinarySteps.step s s1 _ (.base (.ADDI .x7 .x0 3)) 7
  · simpa only [Keygen.fetch_at,pc] using c0
  · rfl
  apply OrdinarySteps.step s1 s2 _ (.base (.ADDI .x10 .x0 65)) 6
  · simpa [Keygen.fetch_at,s1,execInstrBr,signExtend12,signExtend13,signExtend21,pc,ne65bv,eq66bv,MachineState.getReg_setReg_eq,MachineState.getReg_setReg_ne] using c1
  · rfl
  apply OrdinarySteps.step s2 s3 _ (.base (.BEQ .x19 .x10 0x10)) 5
  · simpa [Keygen.fetch_at,s1,s2,execInstrBr,signExtend12,signExtend13,signExtend21,pc,ne65bv,eq66bv,MachineState.getReg_setReg_eq,MachineState.getReg_setReg_ne] using c2
  · rfl
  apply OrdinarySteps.step s3 s4 _ (.base (.ADDI .x10 .x0 66)) 4
  · simpa [Keygen.fetch_at,s1,s2,s3,execInstrBr,signExtend12,signExtend13,signExtend21,pc,ne65bv,eq66bv,MachineState.getReg_setReg_eq,MachineState.getReg_setReg_ne] using c3
  · rfl
  apply OrdinarySteps.step s4 s5 _ (.base (.BEQ .x19 .x10 0x10)) 3
  · simpa [Keygen.fetch_at,s1,s2,s3,s4,execInstrBr,signExtend12,signExtend13,signExtend21,pc,ne65bv,eq66bv,MachineState.getReg_setReg_eq,MachineState.getReg_setReg_ne] using c4
  · rfl
  apply OrdinarySteps.step s5 s6 _ (.base (.ADDI .x7 .x0 10)) 2
  · simpa [Keygen.fetch_at,s1,s2,s3,s4,s5,execInstrBr,signExtend12,signExtend13,signExtend21,pc,ne65bv,eq66bv,MachineState.getReg_setReg_eq,MachineState.getReg_setReg_ne] using c5
  · rfl
  apply OrdinarySteps.step s6 s7 _ (.base (.ADD .x20 .x7 .x0)) 1
  · simpa [Keygen.fetch_at,s1,s2,s3,s4,s5,s6,execInstrBr,signExtend12,signExtend13,signExtend21,pc,ne65bv,eq66bv,MachineState.getReg_setReg_eq,MachineState.getReg_setReg_ne] using c6
  · rfl
  apply OrdinarySteps.step s7 (maxState s) _ (.base (.ADDI .x21 .x0 0)) 0
  · simpa [Keygen.fetch_at,s1,s2,s3,s4,s5,s6,s7,execInstrBr,signExtend12,signExtend13,signExtend21,pc,ne65bv,eq66bv,MachineState.getReg_setReg_eq,MachineState.getReg_setReg_ne] using c7
  · rfl
  exact OrdinarySteps.refl _

theorem max_pc (s : MachineState) (pc : s.pc = 0x198c) (ne65 : s.getReg .x19 ≠ 65) (eq66 : s.getReg .x19 = 66) :
    (maxState s).pc = 0x19b8 := by
  have ne65bv : s.getReg .x19 ≠ (65#64) := by simpa only [show (65 : Word) = (65#64) by decide] using ne65
  have eq66bv : s.getReg .x19 = (66#64) := by simpa only [show (66 : Word) = (66#64) by decide] using eq66
  simp [maxState,execInstrBr,signExtend12,signExtend13,signExtend21,pc,ne65bv,eq66bv,
    MachineState.getReg_setReg_eq,MachineState.getReg_setReg_ne]

theorem max_data (s : MachineState) :
    (maxState s).getReg .x20 = 10 ∧
...
end SigGolfCandidate.Hypertree.GroupedBalancedSignUpperMax6667
