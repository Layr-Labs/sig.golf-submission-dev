import SigGolfCandidate.Hypertree.GroupedGraphPassive

/-! Inlined from SigGolfCandidate.Hypertree.GroupedGraphPassiveCost; its only importer was SigGolfCandidate.Hypertree.GroupedGraphMonitorProgram. -/
section
namespace SigGolfCandidate.Hypertree.GroupedGraphPassiveCost
open SigGolf OracleComp OracleComp.EvalDist OracleSpec Reference GroupedGraphPassive
...
end SigGolfCandidate.Hypertree.GroupedGraphPassiveCost

end

namespace SigGolfCandidate.Hypertree.GroupedGraphMonitorProgram
open SigGolf OracleComp OracleComp.EvalDist OracleSpec Reference GroupedGraphPassive GroupedGraphPassiveCost
set_option backward.isDefEq.respectTransparency false
set_option maxRecDepth 4096
...
end SigGolfCandidate.Hypertree.GroupedGraphMonitorProgram
