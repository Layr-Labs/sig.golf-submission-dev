...
/-! Inlined from SigGolfCandidate.Hypertree.GroupedBalancedVerifyByteCopy67; its only importer was SigGolfCandidate.Hypertree.GroupedBalancedVerifyByteCopyLoop67. -/
section
...
namespace SigGolfCandidate.Hypertree.GroupedBalancedVerifyByteCopy67
...
private theorem word687 : GroupedBalancedVerifyImage67Fast2Byte.code[687]? = some 0x00054983 := by decide
private theorem word688 : GroupedBalancedVerifyImage67Fast2Byte.code[688]? = some 0x00299a13 := by decide
private theorem word689 : GroupedBalancedVerifyImage67Fast2Byte.code[689]? = some 0x01488ab3 := by decide
private theorem word690 : GroupedBalancedVerifyImage67Fast2Byte.code[690]? = some 0x000aab03 := by decide
private theorem word691 : GroupedBalancedVerifyImage67Fast2Byte.code[691]? = some 0x0165a023 := by decide
private theorem word692 : GroupedBalancedVerifyImage67Fast2Byte.code[692]? = some 0x00150513 := by decide
private theorem word693 : GroupedBalancedVerifyImage67Fast2Byte.code[693]? = some 0x00458593 := by decide
private theorem word694 : GroupedBalancedVerifyImage67Fast2Byte.code[694]? = some 0xfff90913 := by decide
private theorem word695 : GroupedBalancedVerifyImage67Fast2Byte.code[695]? = some 0xfe0910e3 := by decide

theorem copyBody_block (s : MachineState) (pc : s.pc = 0x1abc)
    ...
    OrdinarySteps GroupedBalancedVerifyImage67Fast2Byte.image s 9 (copyBody s) := by
  let s1 := execInstrBr s (.LBU .x19 .x10 0)
  let s2 := execInstrBr s1 (.SLLI .x20 .x19 2)
  let s3 := execInstrBr s2 (.ADD .x21 .x17 .x20)
  let s4 := execInstrBr s3 (.LW .x22 .x21 0)
  ...
  change OrdinarySteps GroupedBalancedVerifyImage67Fast2Byte.image s 9 s9
  apply OrdinarySteps.step s s1 _ (.base (.LBU .x19 .x10 0)) 8
  · simp [fetch, pc, GroupedBalancedVerifyImage67Fast2Byte.image, word687]; rfl
  · simp [ordinaryStep, memoryArgumentsValid, signExtend12, validInput, s1]
  apply OrdinarySteps.step s1 s2 _ (.base (.SLLI .x20 .x19 2)) 7
  · have hp : s1.pc = 0x1ac0 := by simp [s1, execInstrBr, pc]; rfl
    simp [fetch, hp, GroupedBalancedVerifyImage67Fast2Byte.image, word688]; rfl
  · rfl
  apply OrdinarySteps.step s2 s3 _ (.base (.ADD .x21 .x17 .x20)) 6
  · have hp : s2.pc = 0x1ac4 := by simp [s1, s2, execInstrBr, pc]; rfl
    simp [fetch, hp, GroupedBalancedVerifyImage67Fast2Byte.image, word689]; rfl
  · rfl
  apply OrdinarySteps.step s3 s4 _ (.base (.LW .x22 .x21 0)) 5
  · have hp : s3.pc = 0x1ac8 := by simp [s1, s2, s3, execInstrBr, pc]; rfl
    simp [fetch, hp, GroupedBalancedVerifyImage67Fast2Byte.image, word690]; rfl
  · simp [s1,s2,s3,s4,ordinaryStep,memoryArgumentsValid,signExtend12]
    exact validTable
  apply OrdinarySteps.step s4 s5 _ (.base (.SW .x11 .x22 0)) 4
  · have hp : s4.pc = 0x1acc := by simp [s1, s2, s3, s4, execInstrBr, pc]; rfl
    simp [fetch, hp, GroupedBalancedVerifyImage67Fast2Byte.image, word691]; rfl
  · simp [s1,s2,s3,s4,s5,ordinaryStep,memoryArgumentsValid,signExtend12]
    exact validOutput
  apply OrdinarySteps.step s5 s6 _ (.base (.ADDI .x10 .x10 1)) 3
  · have hp : s5.pc = 0x1ad0 := by simp [s1, s2, s3, s4, s5, execInstrBr, pc]; rfl
    simp [fetch, hp, GroupedBalancedVerifyImage67Fast2Byte.image, word692]; rfl
  · rfl
  apply OrdinarySteps.step s6 s7 _ (.base (.ADDI .x11 .x11 4)) 2
  · have hp : s6.pc = 0x1ad4 := by simp [s1, s2, s3, s4, s5, s6, execInstrBr, pc]; rfl
    simp [fetch, hp, GroupedBalancedVerifyImage67Fast2Byte.image, word693]; rfl
  · rfl
  apply OrdinarySteps.step s7 s8 _ (.base (.ADDI .x18 .x18 (-1))) 1
  · have hp : s7.pc = 0x1ad8 := by simp [s1, s2, s3, s4, s5, s6, s7, execInstrBr, pc]; rfl
    simp [fetch, hp, GroupedBalancedVerifyImage67Fast2Byte.image, word694]; rfl
  · rfl
  apply OrdinarySteps.step s8 s9 _ (.base (.BNE .x18 .x0 (-32))) 0
  · have hp : s8.pc = 0x1adc := by simp [s1, s2, s3, s4, s5, s6, s7, s8, execInstrBr, pc]; rfl
    simp [fetch, hp, GroupedBalancedVerifyImage67Fast2Byte.image, word695]; rfl
  · rfl
...
end SigGolfCandidate.Hypertree.GroupedBalancedVerifyByteCopy67
...
namespace SigGolfCandidate.Hypertree.GroupedBalancedVerifyByteCopyLoop67
...
theorem copyLoop_steps (s : MachineState)
    (pc : s.pc = 0x1abc) (rem : s.getReg .x18 = 16)
    (input : s.getReg .x10 = 0x80500) (output : s.getReg .x11 = 0x80600)
    (table : s.getReg .x17 = 0xfff800 ∨ s.getReg .x17 = 0xfffc00)
    (n : Nat) (hn : n ≤ 16) :
    OrdinarySteps GroupedBalancedVerifyImage67Fast2Byte.image s (9*n) (copyLoop s n) := by
  induction n with
  | zero => simpa [copyLoop] using OrdinarySteps.refl (image := GroupedBalancedVerifyImage67Fast2Byte.image) s
  | succ n ih =>
    have hn0 : n ≤ 16 := by omega
    have hn1 : n < 16 := by omega
    have initial := ih hn0
    have hpc : (copyLoop s n).pc = 0x1abc := by
...
end SigGolfCandidate.Hypertree.GroupedBalancedVerifyByteCopyLoop67
