...
/-! Inlined from SigGolfCandidate.Hypertree.GroupedBalancedVerifyByteDigits67; its only importer was SigGolfCandidate.Hypertree.GroupedBalancedVerifyByteFullDigits67. -/
section
...
namespace SigGolfCandidate.Hypertree.GroupedBalancedVerifyByteDigits67
...
end SigGolfCandidate.Hypertree.GroupedBalancedVerifyByteDigits67
...
open SigGolfCandidate.Hypertree.GroupedBalancedVerifyByteDigits67
...
namespace SigGolfCandidate.Hypertree.GroupedBalancedVerifyByteFullDigits67
...
theorem fullDecoder_digits (s : MachineState) (message : BitVec 128)
  ...
  have hflip_q : ∀ entry : Fin 256, ∀ k : Fin 4,
    ...
    exact hflip entry k
  change ∀ chain : Fin 67,
    (GroupedBalancedVerifyByteCompose67.postSumState q message).getByte
      (BitVec.ofNat 64 (0x80600+chain.val)) =
...
end SigGolfCandidate.Hypertree.GroupedBalancedVerifyByteFullDigits67
