...
namespace SigGolfCandidate.Hypertree.GroupedBalancedSignByteTableFrame67
...
theorem copyLoop_table_byte (s : MachineState) (n : Nat)
  ...
  | succ n ih =>
    ...
    change (GroupedBalancedSignByteCopy67.copyBody (copyLoop s n)).getByte _ = _
...
end SigGolfCandidate.Hypertree.GroupedBalancedSignByteTableFrame67
